          ...
          <ScrollArea className="h-full">
            <div className="space-y-6 pr-4">
              ...
              {procedure.safetyNotes && (
                <Card className="border-[hsl(var(--warning))] bg-[hsl(var(--warning)/0.05)] dark:border-[hsl(var(--warning)/0.8)] dark:bg-[hsl(var(--warning)/0.1)]">
                  <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                    <CardTitle className="text-sm font-medium text-[hsl(var(--warning-foreground))] dark:text-[hsl(var(--warning))]">
                      Notas de Segurança
                    </CardTitle>
                    <Warning className="h-4 w-4 text-[hsl(var(--warning))] dark:text-[hsl(var(--warning))]" />
                  </CardHeader>
                  <CardContent>
                    <div className="text-sm text-[hsl(var(--warning-foreground))] dark:text-[hsl(var(--warning))] whitespace-pre-wrap">
                      {procedure.safetyNotes}
                    </div>
                  </CardContent>
                </Card>
